...
- **Verbatim intent**: the Request column holds the human's exact prompt — typos and all, never summarized — so future agents read intent in the human's own words, not an agent's paraphrase.
